...
<html lang="en">
  ...
  <body>
    <h2 class="text-center mt-4 mb-4">TAMBAH DATA PEGAWAI</h2>
      ...
      <div class="row justify-content-center">
            ...
            <div class="col-6">
              ...
              <div class="mb-3">
                ...
                <input type="number" name="notelpon" class="form-control mb-3" id="exampleInputEmail1" aria-describedby="emailHelp">
